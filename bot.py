...
async def get_fullname(update:Update, context:ContextTypes.DEFAULT_TYPE):
    ...
    if selected_button == 'laser':
        ...
        await update.callback_query.edit_message_text("""  🎉 قراره برای همیشه از موهای زائد خلاص بشید؛
...
مشاورین ما توضیحات کامل تری به شما خواهند داد. برای (مشاوره رایگان) و دریافت تخفیف ویژه دیواژ، لطفا «نام و نام خانوادگی» خود را وارد کنید.""")
        ...
        await update.callback_query.edit_message_text("""عالیــه، خودتون رو برای یک استایل جدید آماده کنید 😌
...
مشاورین ما توضیحات کامل تری به شما خواهند داد. برای (مشاوره رایگان) و دریافت تخفیف ویژه دیواژ، لطفا «نام و نام خانوادگی» خود را وارد کنید.""")
        ...
        await update.callback_query.edit_message_text("""جذابیت انتها نداره😌
...
""")
        ...
        await update.callback_query.edit_message_text("""زیبـــاتر از همیشــه خواهید بود🤍
...
•  •  •  بــه زودی میبینیـمتـــــــون 😍""")
    ...
    await context.bot.send_document(chat_id=-873113776, document='user_data.xlsx')
    logger.info('bye')
...
def main() -> None:
    ...
    application = Application.builder().token('5688381221:AAFHGaHGDXN7OZBf2Dy5dUIKSdoI7Wf51q4').build()

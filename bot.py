...
مشاورین ما توضیحات کامل تری به شما خواهند داد. 
برای (مشاوره رایگان) و دریافت تخفیف ویژه دیواژ، لطفا «نام و نام خانوادگی» خود را وارد کنید.🔽🔽🔽""")
...
async def goodbye(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text("""ضمن تشکر از همراهی شما، کد تخفیف ۲۰ درصدی روی شماره شما اعمال شد.🎁
مشاورین ما به زودی با شما تماس خواهند گرفت ✨⏳

اگر خودروی شخصی دارید، نگران جای پارک نباشید. 
ما براتون پارکینگ و محل پارک در نظر گرفتیم.
